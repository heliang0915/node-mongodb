...
router.route('/').all(function (req, res) {
    ...
    console.log(params);
    res.render(config.product.index, {title:config.productBrand.title,action:config.productBrand.module.toLocaleLowerCase(), pageIndex: config.product.pageIndex, active: 'active'});
})
