...
router.route('/').all(function (req, res) {
    ...
    console.log(params);
    res.render(config.product.index, {title:config.productSpecifications.title,action:config.productSpecifications.action.toLocaleLowerCase(), pageIndex:config.product.pageIndex,active:'active'});
})
