...
router.route('/').all(function (req, res) {
    ...
    console.log(params);
    res.render(config.product.index, {title:config.productTag.title,action:config.productTag.action.toLocaleLowerCase(), pageIndex:config.product.pageIndex,active:'active'});
})
